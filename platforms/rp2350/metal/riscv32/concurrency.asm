# RP2350 board fork (P8): task memory arenas sized for 520 kB SRAM —
# 64 tasks x (2 KiB data stack + 1 KiB call stack) = 192 KiB, instead of the
# QEMU-virt 64 KiB-per-task slices. Same code and slot layout otherwise.
# ---------------------------------------------------------------------------
...
.spawn_found:
    ...
    add t0, t0, t1
    sw s4, 0(t0)
    # set DS pointer: __task_ds_mem + task_id * 2048
    la t0, __task_ds_mem
    slli t1, s0, 11
...
__task_ds_mem:  .space 131072
__task_cs_mem:  .space 65536
