...
pub fn emit_region_create(gen: &mut X86_64HostedBackend<'_>) {
    ...
    write_u32(gen.out, size_ok);
    gen.out.write(b":\n");
    gen.out.write(b"  mov rax, [__region_next]\n");
    gen.out.write(b"  cmp rax, 16\n");
    gen.out.write(b"  jb .region_make_ok_");
    ...
    gen.out.write(b"\n");
    gen.out.write(b"  jmp __lang_trap\n");
    gen.out.write(b".region_make_ok_");
    write_u32(gen.out, ok);
    gen.out.write(b":\n");
    gen.out.write(b"  mov rcx, rax\n");
    ...
    write_u32(gen.out, mmap_ok);
    gen.out.write(b":\n");
    gen.out.write(b"  mov rdx, rcx\n");
    gen.out.write(b"  add rdx, 1\n");
    gen.out.write(b"  mov [__region_next], rdx\n");
