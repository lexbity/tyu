...
//!
//! This crate layers the hosted panic handler, EH personality, global
//! allocator, and `entry!` macro on top of `hosted`, so the `#![no_std]`
//! host binaries (`langc`, `lang-assemble`) get a working runtime.
